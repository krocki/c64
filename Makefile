...
c64_nolcd: 6502.o 6502.h Makefile c64_nolcd.o
	${GCC} c64_nolcd.o 6502.o ${C_FLAGS} ${GL_FLAGS} -o $@

c64_lcd: 6502.o 6502.h Makefile c64_lcd.o
	${GCC} c64_lcd.o 6502.o ${C_FLAGS} ${GL_FLAGS} -o $@
